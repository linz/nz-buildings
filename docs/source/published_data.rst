...
To enable changes between updates to be recorded and then queried using using LINZ Data Service changesets, every table has a primary key. Primary keys in tables are shown by a field name with bold font.
