-- Deploy buildings:buildings_reference/schema_and_tables to pg
...
CREATE SCHEMA buildings_reference;
...
-- Suburb / Locality
CREATE TABLE buildings_reference.suburb_locality (
...
-- Town / City
CREATE TABLE buildings_reference.town_city (
...
CREATE TABLE buildings_reference.territorial_authority (
...
-- Coastline
CREATE TABLE buildings_reference.coastlines_and_islands (
...
-- River Polygons
CREATE TABLE buildings_reference.river_polygons (
...
-- Lake Polygons
CREATE TABLE buildings_reference.lake_polygons (
...
-- Pond Polygons
CREATE TABLE buildings_reference.pond_polygons (
...
-- Swamp Polygons
CREATE TABLE buildings_reference.swamp_polygons (
...
-- Lagoon Polygons
CREATE TABLE buildings_reference.lagoon_polygons (
...
-- Canal Polygons
CREATE TABLE buildings_reference.canal_polygons (
...
-- Capture Source Area
CREATE TABLE buildings_reference.capture_source_area (
...
CREATE TABLE buildings_reference.reference_update_log (
