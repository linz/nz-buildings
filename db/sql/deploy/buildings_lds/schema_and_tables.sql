-- Deploy nz-buildings:buildings_lds/schema_and_tables to pg
...
CREATE INDEX sidx_nz_building_outlines
    ON buildings_lds.nz_building_outlines USING gist (shape);
...
CREATE INDEX sidx_nz_building_outlines_all_sources
    ON buildings_lds.nz_building_outlines_all_sources USING gist (shape);
