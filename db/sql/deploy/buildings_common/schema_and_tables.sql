-- Deploy buildings:buildings_common/schema_and_tables to pg
...
-- buildings_common
CREATE SCHEMA buildings_common;
...
CREATE TABLE buildings_common.capture_method (
...
CREATE TABLE buildings_common.capture_source_group (
...
-- Capture Source
-- Lookup table that holds all of the methods by which the geometry was captured.
CREATE TABLE buildings_common.capture_source (
