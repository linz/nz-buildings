...
--          
--  NOTE: related comparisons have been turned off for now, due to problems
--          with long processing times using the RECURSIVE function.
-------------------------------------------------------------
...
$$
    ...
    WITH intersects AS (
        ...
        HAVING count(bulk_load_outline_id) = 1 -- >= 1
    )
...
$$
    ...
    WITH intersects AS (
        ...
        HAVING count(building_outline_id) = 1 -- >= 1
    )
