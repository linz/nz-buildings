...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="building_outline_id">
    ...
    <edittype widgetv2type="TextEdit" name="lifecycle_stage_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="end_lifespan">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <displayfield>supplied_o</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="building_outline_id" index="0" name=""/>
    <alias field="building_id" index="1" name=""/>
    <alias field="capture_method_id" index="2" name=""/>
    <alias field="capture_source_id" index="3" name=""/>
    <alias field="lifecycle_stage_id" index="4" name=""/>
    <alias field="suburb_locality_id" index="5" name=""/>
    <alias field="town_city_id" index="6" name=""/>
    <alias field="territorial_authority_id" index="7" name=""/>
    <alias field="begin_lifespan" index="8" name=""/>
    <alias field="end_lifespan" index="9" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="building_outline_id"/>
      <column width="-1" hidden="0" type="field" name="building_id"/>
      <column width="-1" hidden="0" type="field" name="lifecycle_stage_id"/>
      <column width="-1" hidden="0" type="field" name="end_lifespan"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="building_outline_id" expression=""/>
    <default field="building_id" expression=""/>
    <default field="capture_method_id" expression=""/>
    <default field="capture_source_id" expression=""/>
    <default field="lifecycle_stage_id" expression=""/>
    ...
    <default field="end_lifespan" expression=""/>
  </defaults>
