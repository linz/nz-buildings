...
class ProductionFrame(QFrame, FORM_CLASS):
    ...
    def cb_production_clicked(self, checked):
        ...
        added_category = [ln for ln in categories if ln.data(Qt.DisplayRole) == "Building Outlines"]
        if checked:
    ...
    def reload_production_layer(self):
        ...
        self.parent_frame.cb_production_clicked(False)
        self.parent_frame.cb_production_clicked(True)
